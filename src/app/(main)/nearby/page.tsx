...
export default function NearbyPage() {
  ...
  return (
    <div className="container mx-auto py-8 px-4">
      <h1 className="text-3xl font-bold text-center mb-2 font-headline">Culture Near You</h1>
      ...
      <h2 className="text-2xl font-semibold mb-6 mt-10 font-headline">Nearby Highlights (Sample Data)</h2>
      {nearbyItems.length > 0 ? (
        ...
        <p className="text-center text-muted-foreground font-body">No nearby items to display with sample data.</p>
      )}
    </div>
  );
}
